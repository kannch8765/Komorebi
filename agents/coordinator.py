...
def create_coordinator(
    ...
    return Agent(
        ...
        instruction=(
            ...
            "- TIME BUDGET ('N分' / 'N時間' / 'within X minutes' / 'takes less than N') → "
            "call route_agent FIRST to verify which destinations are reachable within the budget, "
            "THEN call places_agent around the verified destinations; the time budget is a "
            "HARD constraint, not a fuzzy hint.\n"
